package com.anlijiu.example.ui.misc;
...
public abstract class BindableAdapter<T> extends BaseAdapter {
    ...
    /**
     * BindView the data for the specified {@code position} to the view.
     */
    ...
    /**
     * BindView the data for the specified {@code position} to the drop-down view.
     */
